...
public class Config {
    ...
    public final static HashMap<String, CheckListboxItem> icons = new HashMap<String, CheckListboxItem>(31) {{
    ...
    public final static HashMap<String, CheckListboxItem> flowermenus = new HashMap<String, CheckListboxItem>(14) {{
